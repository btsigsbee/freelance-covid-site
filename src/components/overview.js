    ...
    return (
        <div className='container'>
            ...
            <Col ><text className='font-mont text-wrap font-color-dark'> This study seeks to understand how parents manage parenting and working from home during the COVID-19 pandemic.
                ...
                The study will contribute to knowledge about <text className='font-weight-bold font-color-sec'>work-life balance</text><text className='font-weight-bold font-color-sec'>, parenting</text>, and <text className='font-weight-bold font-color-sec'>how couples cope with stress</text>.
                </text> 
                <br /><br />
                <text className=' font-mont text-wrap font-color-dark'>We want to hear from both 
                    <text className='font-weight-bold font-color-sec'> Moms and Dads</text>, and we want to hear the highs and lows of working and parenting from home! It doesn't matter what your experience has been, we want to hear from you!
                    </text>
                    <br /> 
                    <br/>
